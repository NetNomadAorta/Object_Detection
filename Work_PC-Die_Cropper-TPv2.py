...
DATASET_PATH = "./" + SAVE_NAME_OD.split("./Models-OD/",1)[1].split("-",1)[0] +"/"
FILE_NAME_TO_CROP = "SMiPE4-581"
IMAGE_SIZE = int(re.findall(r'\d+', SAVE_NAME_OD)[-1] ) # Row and column number 2180
